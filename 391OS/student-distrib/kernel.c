...
void entry(unsigned long magic, unsigned long addr) {
    ...
    if (CHECK_FLAG(mbi->flags, 3)) {
        ...
        address_of_module = (unsigned int) mod->mod_start;
        ...
        init_file_system(address_of_module);
    }
    ...
    /* Initialize PIC to service RTC interrupts */
    init_rtc();
    cli();
    ...
    /* Initialize PIC to service keyboard interrupts */
    init_keyboard();
    cli();
